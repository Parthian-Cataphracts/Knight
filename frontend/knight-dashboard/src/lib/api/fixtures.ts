...
export const installations: Installation[] = [
  { id: "i1", storeId: "s1", storeName: "cafe1.ir", featureId: "f2", featureName: "تحلیل پیشرفته", featureSlug: "knight-feature-analytics", entitled: true, installedVersion: null, desiredVersion: "1.4.0", state: "Failed", isEnabled: false, health: "Offline", blockingReason: "ProgrammingError در مهاجرت ۰۰۰۳", rollbackOutcome: "ManualInterventionRequired", lastTransitionAt: minutesAgo(12) },
  { id: "i2", storeId: "s1", storeName: "cafe1.ir", featureId: "f1", featureName: "هسته تحلیل داده", featureSlug: "knight-feature-analytics-core", entitled: true, installedVersion: "1.2.3", desiredVersion: "1.2.3", state: "Installed", isEnabled: true, health: "Healthy", blockingReason: null, rollbackOutcome: null, lastTransitionAt: daysAgo(9) },
  { id: "i3", storeId: "s2", storeName: "staging.cafe1.ir", featureId: "f2", featureName: "تحلیل پیشرفته", featureSlug: "knight-feature-analytics", entitled: true, installedVersion: "1.3.1", desiredVersion: "1.4.0", state: "Updating", isEnabled: true, health: "Healthy", blockingReason: null, rollbackOutcome: null, lastTransitionAt: minutesAgo(3) },
  { id: "i4", storeId: "s3", storeName: "cafe2.ir", featureId: "f3", featureName: "گزارش‌های هوشمند", featureSlug: "knight-feature-ai-reports", entitled: true, installedVersion: null, desiredVersion: null, state: "NotInstalled", isEnabled: false, health: "Unknown", blockingReason: "نیازمند زیرساخت اختصاصی؛ میزبانی فعلی اشتراکی است.", rollbackOutcome: null, lastTransitionAt: daysAgo(3) },
  { id: "i5", storeId: "s3", storeName: "cafe2.ir", featureId: "f4", featureName: "اعلان پیامکی", featureSlug: "knight-feature-sms", entitled: true, installedVersion: "1.1.0", desiredVersion: "1.1.0", state: "Installed", isEnabled: true, health: "Healthy", blockingReason: null, rollbackOutcome: null, lastTransitionAt: daysAgo(21) },
  { id: "i6", storeId: "s5", storeName: "alborz.ir", featureId: "f4", featureName: "اعلان پیامکی", featureSlug: "knight-feature-sms", entitled: false, installedVersion: "1.0.2", desiredVersion: null, state: "Disabled", isEnabled: false, health: "Unknown", blockingReason: "اشتراک منقضی شده؛ داده تا ۳۰ روز نگهداری می‌شود.", rollbackOutcome: null, lastTransitionAt: daysAgo(6) },
  { id: "i7", storeId: "s4", storeName: "parsbakery.ir", featureId: "f1", featureName: "هسته تحلیل داده", featureSlug: "knight-feature-analytics-core", entitled: true, installedVersion: "1.2.3", desiredVersion: "1.2.3", state: "Installed", isEnabled: true, health: "Healthy", blockingReason: null, rollbackOutcome: null, lastTransitionAt: daysAgo(30) },
];

export const jobs: Job[] = [
  {
    id: "j1", type: "Upgrade", status: "Running", storeId: "s2", storeName: "staging.cafe1.ir",
    target: "knight-feature-analytics 1.3.1 → 1.4.0", currentStep: 5, totalSteps: 9,
    steps: [
      { index: 1, name: "preflight", status: "Succeeded", output: "سازگاری تایید شد" },
      { index: 2, name: "fetch", status: "Succeeded", output: "digest تایید شد" },
      { index: 3, name: "backup", status: "Succeeded", output: "snapshot ثبت شد" },
      { index: 4, name: "install", status: "Succeeded", output: null },
      { index: 5, name: "migrate", status: "Running", output: "Applying 0002_add_report_index (2/4)" },
      { index: 6, name: "configure", status: "Pending", output: null },
      { index: 7, name: "enable", status: "Pending", output: null },
      { index: 8, name: "reload", status: "Pending", output: null },
      { index: 9, name: "healthcheck", status: "Pending", output: null },
    ],
    errorCode: null, rollbackOutcome: null, queuedAt: minutesAgo(4), startedAt: minutesAgo(3), finishedAt: null, correlationId: "0HMV9A2C41",
  },
  {
    id: "j2", type: "Install", status: "Failed", storeId: "s1", storeName: "cafe1.ir",
    target: "knight-feature-analytics 1.4.0", currentStep: 5, totalSteps: 9,
    steps: [
      { index: 1, name: "preflight", status: "Succeeded", output: null },
      { index: 2, name: "fetch", status: "Succeeded", output: null },
      { index: 3, name: "backup", status: "Succeeded", output: null },
      { index: 4, name: "install", status: "Succeeded", output: null },
      { index: 5, name: "migrate", status: "Failed", output: 'ProgrammingError: relation "analytics_report" already exists' },
      { index: 6, name: "configure", status: "Skipped", output: null },
      { index: 7, name: "enable", status: "Skipped", output: null },
      { index: 8, name: "reload", status: "Skipped", output: null },
      { index: 9, name: "healthcheck", status: "Skipped", output: null },
    ],
    errorCode: "migration_failed", rollbackOutcome: "ManualInterventionRequired", queuedAt: minutesAgo(16), startedAt: minutesAgo(15), finishedAt: minutesAgo(12), correlationId: "0HMV9A1B77",
  },
  {
    id: "j3", type: "Provision", status: "Queued", storeId: "s6", storeName: "novin.ir",
    target: "پیکربندی اولیه فروشگاه", currentStep: 0, totalSteps: 8, steps: [],
    errorCode: null, rollbackOutcome: null, queuedAt: minutesAgo(6), startedAt: null, finishedAt: null, correlationId: "0HMV9A3D02",
  },
  {
    id: "j4", type: "Backup", status: "Succeeded", storeId: "s4", storeName: "parsbakery.ir",
    target: "پشتیبان روزانه پایگاه داده", currentStep: 3, totalSteps: 3, steps: [],
    errorCode: null, rollbackOutcome: null, queuedAt: daysAgo(1), startedAt: daysAgo(1), finishedAt: daysAgo(1), correlationId: "0HMV98ZZ10",
  },
  {
    id: "j5", type: "Rollback", status: "Succeeded", storeId: "s3", storeName: "cafe2.ir",
    target: "knight-feature-sms 1.1.0 → 1.0.2", currentStep: 5, totalSteps: 5, steps: [],
    errorCode: null, rollbackOutcome: "Succeeded", queuedAt: daysAgo(2), startedAt: daysAgo(2), finishedAt: daysAgo(2), correlationId: "0HMV97YY31",
  },
];
