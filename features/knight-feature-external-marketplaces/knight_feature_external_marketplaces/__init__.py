"""
`external-marketplaces` — everything that crosses the boundary, as a row.
...
default_app_config = "knight_feature_external_marketplaces.apps.ExternalMarketplacesConfig"
