...
public sealed class FulfillmentAuditRecorder
{
    private const string EntityType = "TenantFulfillmentSettings";
    private readonly ICurrentUser _currentUser;
    private readonly IAuditLogger _auditLogger;

    public FulfillmentAuditRecorder(ICurrentUser currentUser, IAuditLogger auditLogger)
    {
