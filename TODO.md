...
| **Next phase** | **None that this repository can start.** What is left across phases 27, 28 and 29 is: a host and a domain, a backup-custody decision, three service conversions, and an engaged security reviewer. The eleven product-owner answers in [`docs/risks.md`](docs/risks.md) §3 are given; Phonix is dropped (BojanStore is the first project). The two open decisions are in [`docs/roadmap.md`](docs/roadmap.md) §7 |
